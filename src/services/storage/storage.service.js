...
var LocalStorageService = /** @class */ (function () {
    function LocalStorageService() {
        this.uploadDir = process.env.VERCEL ? path_1.default.join('/tmp', 'uploads') : path_1.default.join(process.cwd(), 'uploads');
        if (!fs_1.default.existsSync(this.uploadDir)) {
            fs_1.default.mkdirSync(this.uploadDir, { recursive: true });
        }
    }
    LocalStorageService.prototype.uploadFile = function (buffer, originalName, mimeType) {
        return __awaiter(this, void 0, void 0, function () {
            var ext, filename, filePath;
            return __generator(this, function (_a) {
                ext = path_1.default.extname(originalName) || '';
                filename = "".concat(Date.now(), "-").concat(Math.round(Math.random() * 1e9)).concat(ext);
